...
class App(tk.Frame):  
    def __init__(self, master):
        ...
        self.master = master
        self.DrawArea = tk.Canvas(self, width=600, height=10000, background="white",
...
#       try:
#           with open('../port.txt', 'r') as port_log:
...
#               port_log.write(self.serial_number)
    ...
    def null_data(self, serial_number):
        ...
        self.messages = np.zeros((10000, 3), dtype='object')
        self.to_print = np.zeros((700, 10000), dtype=np.uint8)
        self.mode = 'text'
        self.mesnum = 0
        self.y = 0
        self.incr = 0
    ...
    def choose_port(self):
        ...
        tk.Radiobutton(self.child, text='COM1', variable=self.rvar, value='COM1', indicator=0, width=80, command=self.port_setting).pack(anchor=tk.W)
        tk.Radiobutton(self.child, text='COM2', variable=self.rvar, value='COM2', indicator=0, width=80, command=self.port_setting).pack(anchor=tk.W)
